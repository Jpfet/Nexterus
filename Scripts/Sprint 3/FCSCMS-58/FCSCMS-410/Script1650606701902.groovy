...
WebUI.setText(findTestObject('Sprint 3/FCSCMS-58/FCSCMS-410/Create User_User Name'), 'fet4')

WebUI.setText(findTestObject('Sprint 3/FCSCMS-58/FCSCMS-410/Create User_Email'), 'fet4@mailinator.com')
