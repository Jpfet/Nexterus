...
WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_User Name'), 'Anon User')

WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Email'), 'anonymous@mailinator.com')

WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Address Line 1'), 'Tinago')

WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Address Line 2'), 'M. Castro')
...
WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Phone Number field'), '2027953213')

WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Phone Number _Extension'), '00')

WebUI.selectOptionByLabel(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Mobile Number_Area Code'), '+1', false)

WebUI.setText(findTestObject('Admin/Sprint 4/FCSCMS-122/Edit User_Mobile Number field'), '2027953213')
