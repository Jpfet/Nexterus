...
WebUI.selectOptionByLabel(findTestObject('Admin/Sprint 8/FCSCMS-952/AddItems(tobeShipped)/PiecesType'), 'Bag', false)
...
WebUI.selectOptionByLabel(findTestObject('Admin/Sprint 8/FCSCMS-952/AddItems(tobeShipped)/select_Class'), 'AT Test Class', 
    false)
